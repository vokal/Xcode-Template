...
#import "___VARIABLE_classPrefix___BaseCollectionViewCell.h"

@interface ___VARIABLE_classPrefix___BaseCollectionViewCell ()

@property BOOL oneTimeThingsAreSetUp;

@end

@implementation ___VARIABLE_classPrefix___BaseCollectionViewCell
