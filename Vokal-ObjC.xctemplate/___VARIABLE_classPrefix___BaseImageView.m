...
#import "___VARIABLE_classPrefix___BaseImageView.h"

@interface ___VARIABLE_classPrefix___BaseImageView ()

@property (nonatomic, readwrite) BOOL oneTimeThingsAreSetUp;

@end

@implementation ___VARIABLE_classPrefix___BaseImageView
